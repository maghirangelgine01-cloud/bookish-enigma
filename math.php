...
$sql = "SELECT id, student_name, math_score, average, grade 
        FROM grades ORDER BY math_score DESC";
...
<head>
  ...
  <title>Math Rankings | Admin</title>
...
<body>
  ...
  <div class="main-content">
    <header>
      <h1>📘 Math Rankings</h1>
       <p class="teacher-info">Taught by: PROF. MAGHIRANG</p>
